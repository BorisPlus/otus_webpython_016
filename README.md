...
```
Число запросов увеличилось до **14**! Мне показалось это странным, я думал, раз мы добавляем фильтр по одной модели, то должен быть и один запрос. А тут 9 добавилось...
